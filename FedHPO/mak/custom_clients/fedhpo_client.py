...
class FedHpoClient(fl.client.NumPyClient):
    """Flower NumPy Client implementing FedHPO"""
    def __init__(
        self,
    ...
    def evaluate(self, parameters, config):
        self.model.set_weights(parameters)
        print("Inside evalvate FedHPO Client")
        loss, accuracy = self.model.evaluate(self.x_test, self.y_test, verbose=1)
        print("Eval accuracy on FedHpo Client {} : {}".format(self.client_name,accuracy))
